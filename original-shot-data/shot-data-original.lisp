...
(setf shotdata3  (make-shotdata
                      :battery-angle '(11.25 90 168.75 258.75 348.75) ; 4 way
...
(setf shotdata shotdata0)
(setf (aref *shot-pattern-data* 0) shotdata)
(setf shotdata shotdata1)
(setf (aref *shot-pattern-data* 1) shotdata)
(setf shotdata shotdata2)
(setf (aref *shot-pattern-data* 2) shotdata)
(setf shotdata shotdata3)
(setf (aref *shot-pattern-data* 3) shotdata)
(setf shotdata shotdata4)
(setf (aref *shot-pattern-data* 4) shotdata)
(setf shotdata shotdata5)
(setf (aref *shot-pattern-data* 5) shotdata)
(setf shotdata shotdata6)
(setf (aref *shot-pattern-data* 6) shotdata)
(setf shotdata shotdata7)
(setf (aref *shot-pattern-data* 7) shotdata)
(setf shotdata shotdata8)
(setf (aref *shot-pattern-data* 8) shotdata)
(setf shotdata shotdata9)
(setf (aref *shot-pattern-data* 9) shotdata)
(setf shotdata shotdata10)
(setf (aref *shot-pattern-data* 10) shotdata)
(setf shotdata shotdata11)
(setf (aref *shot-pattern-data* 11) shotdata)
(setf shotdata shotdata12)
(setf (aref *shot-pattern-data* 12) shotdata)
(setf shotdata shotdata13)
(setf (aref *shot-pattern-data* 13) shotdata)
